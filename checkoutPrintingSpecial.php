...
if (isset($_POST['btnCheckout'])) 
{
    ...
    $deliverylocation=$_POST['txtdeliverylocation'];
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Special Order for Printing</h2>
                            <nav class="bradcaump-content">
                              <a class="breadcrumb_item" href="index.php">Home</a>
                              <span class="brd-separetor">/</span>
                              <span class="breadcrumb_item active">Special Order for Printing</span>
                            </nav>
                        </div>
                    </div>
                </div>
        	...
        	<div class="container">
        		...
        		<div class="row">
        			...
        			<div class="col-lg-6 col-12">
        				<form action="checkoutPrintingSpecial.php" method="POST" enctype="multipart/form-data">
        				<div class="customer_details">
        					...
        					<div class="payment">
							<input type="radio" name="rdoPaymentType" value="COD" checked onClick="printing()" /> Printing
							</div>
        				</div>      				
        				<!-- payment End --> 
        						<div class="input_box">
                                ...
                                <div class="input_box" id="printing">
        							<label>Delivery Location <span>*</span></label>
									<input type="text" name="txtdeliverylocation" placeholder="kingstudio or my house" required>
        			...
        			<div class="col-lg-6 col-12 md-mt-40 sm-mt-40">
        				<form action="checkoutPrintingSpecial.php" method="POST">
